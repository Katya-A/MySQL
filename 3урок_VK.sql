...
CREATE TABLE `languages` (
	id SERIAL PRIMARY KEY,
	language_name varchar(255) COMMENT 'язык который вы знаете',
	lavel_language varchar(255)COMMENT 'уровень'
);
...
CREATE TABLE `education` (
	...
	school varchar(355) COMMENT 'ваша школа',
	education ENUM('higher', 'secondary', 'average'),
	university varchar(255) COMMENT 'какой университет',
...
CREATE TABLE `hobby` (
	id SERIAL PRIMARY KEY,
	hobby varchar(255) COMMENT 'ваши увлечения'
);
